<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="w-full px-6">
        <div class="flex justify-between h-16-[96px]">
            <div class="flex">
                <!-- Logo -->
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Manage Smartphone -->
                    <x-nav-link :href="route('smartphones.index')" :active="request()->routeIs('smartphones.*')">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-4 py-2 border border-transparent text-base leading-5 font-semibold rounded-md text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 hover:text-gray-900 dark:hover:text-white focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('smartphones.index')" :active="request()->routeIs('smartphones.*')">
                📱 {{ __('Manage Smartphone') }}
            </x-responsive-nav-link>
        </div>
