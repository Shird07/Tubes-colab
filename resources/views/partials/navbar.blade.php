    ...
    <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <a href="{{ route('home') }}" class="flex items-center gap-2">
            <svg
                ...
                class="h-9 w-auto fill-current text-indigo-500"
            ...
            <span class="font-semibold text-white">SmartRec</span>
        </a>
        ...
        <div class="flex gap-6 text-sm">
            ...
            @auth
                ...
                @if(auth()->user()->role === 'admin')
                    <a href="{{ route('smartphones.index') }}" class="hover:text-blue-400">
                        Kelola Smartphone
                    </a>
                @endif
            @endauth
